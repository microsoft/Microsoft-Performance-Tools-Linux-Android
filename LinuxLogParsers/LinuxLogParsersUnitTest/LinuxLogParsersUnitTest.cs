...
namespace LinuxLogParsersUnitTest
{
    ...
    public class LinuxLogParsersUnitTest
    {
        ...
        public void AndroidLogcat()
        {
            ...
            Assert.IsTrue(eventData.DurationLogEntries.Count == 1013);
            ...
            Assert.IsTrue(eventData.DurationLogEntries[909].Name == "main h=android.app.ActivityThread$H");
            Assert.IsTrue(eventData.DurationLogEntries[909].Duration.ToMilliseconds == 2033);
        }
