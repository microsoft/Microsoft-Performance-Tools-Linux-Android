...
namespace PerfDataExtensions.DataOutputTypes
{
    public struct DataSize : IEquatable<DataSize>, IComparable<DataSize>, IComparable
    {
        ...
        const ulong BytesPerMebibyte = BytesPerKibibyte * 1024;
        const decimal MebibytesPerByte = 1m / BytesPerMebibyte;

        const ulong BytesPerGibibyte = BytesPerMebibyte * 1024;
        const decimal GibibytesPerByte = 1m / BytesPerGibibyte;

        const ulong BytesPerTebibyte = BytesPerGibibyte * 1024;
