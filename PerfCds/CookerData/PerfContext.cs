...
namespace PerfCds.CookerData
{
    ...
    public class PerfContext
        : ICursor
    {
        private readonly PerfMetadataCustomization metadata;
        private readonly ICtfInputStream eventStream;
        private readonly TraceContext traceContext;

        internal PerfContext(PerfMetadataCustomization metadata, ICtfInputStream eventStream, TraceContext traceContext)
        {
        ...
        /// <summary>
        /// The clocks described in the Perf CTF trace.
        /// </summary>
